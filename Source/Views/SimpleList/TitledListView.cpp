...
TitledListView::TitledListView(const juce::StringArray& listItems, const juce::String& titleString, ListTitle::IconType type, const juce::String& iconString)
    : listView(listItems),
...
SimpleListView& TitledListView::getListView()
{
