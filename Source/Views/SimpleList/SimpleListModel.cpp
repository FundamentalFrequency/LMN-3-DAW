...
int SimpleListModel::getNumRows()
{

    return items.size();

}
void SimpleListModel::paintListBoxItem (int rowNumber,
                                                 juce::Graphics& g,
...
juce::Component* SimpleListModel::refreshComponentForRow(int rowNumber, bool isRowSelected, juce::Component* existingComponentToUpdate)
{
