...
TitledSplitListView::TitledSplitListView(const juce::StringArray& leftListItems, const juce::StringArray& rightListItems, const juce::String& titleString, ListTitle::IconType type, const juce::String& iconString)
...
SplitListView& TitledSplitListView::getSplitListView()
{
