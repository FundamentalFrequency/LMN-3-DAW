...
SimpleListItemView::SimpleListItemView(juce::String title) {
    // set default colors
    getLookAndFeel().setColour(selectedBackgroundColourId,
                               juce::Colours::black);
    getLookAndFeel().setColour(unselectedBackgroundColourId,
                               juce::Colours::black);
    ...
    backgroundColour =
        getLookAndFeel().findColour(unselectedBackgroundColourId);
...
void SimpleListItemView::setSelected(bool selected) {
    ...
    if (isSelected) {
        backgroundColour =
            getLookAndFeel().findColour(selectedBackgroundColourId);
