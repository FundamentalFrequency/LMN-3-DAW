...
juce::ApplicationCommandTarget* ADSRParametersView::getNextCommandTarget()
{

    return findFirstTargetParentComponent();
}

void ADSRParametersView::getAllCommands(juce::Array<juce::CommandID>& commands)
{
...
void ADSRParametersView::getCommandInfo (juce::CommandID commandID, juce::ApplicationCommandInfo& result)
{
...
bool ADSRParametersView::perform (const InvocationInfo &info)
{
