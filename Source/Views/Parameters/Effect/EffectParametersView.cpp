...
juce::ApplicationCommandTarget* EffectParametersView::getNextCommandTarget()
{

    return findFirstTargetParentComponent();
}

void EffectParametersView::getAllCommands(juce::Array<juce::CommandID>& commands)
{
...
void EffectParametersView::getCommandInfo (juce::CommandID commandID, juce::ApplicationCommandInfo& result)
{
...
bool EffectParametersView::perform (const InvocationInfo &info)
{
