...
class DeviceTypeListView : public juce::Component,
  ...
  private:
    ...
    app_view_models::DeviceTypeListViewModel viewModel;
    TitledListView titledList;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(DeviceTypeListView)
};
