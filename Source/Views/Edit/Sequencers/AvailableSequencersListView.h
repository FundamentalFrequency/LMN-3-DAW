...
class AvailableSequencersListView
...
public:
    ...
    AvailableSequencersListView(tracktion_engine::AudioTrack::Ptr t, app_services::MidiCommandManager& mcm);
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(AvailableSequencersListView)
};
