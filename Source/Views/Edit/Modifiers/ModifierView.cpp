...
void ModifierView::init() {
    ...
    for (int i = 0; i < viewModel->getNumberOfParameters(); i++) {
        ...
        knobs[i]->getLabel().setText(viewModel->getParameterName(i),
                                     juce::dontSendNotification);
        knobs[i]->getSlider().setRange(viewModel->getParameterRange(i),
...
void ModifierView::encoder1Increased() {
    ...
    if (!midiCommandManager.isShiftDown)
        ...
        viewModel->setParameterValue(8, viewModel->getParameterValue(8) +
                                            viewModel->getParameterInterval(8));
}
...
void ModifierView::encoder2Increased() {
    ...
    if (!midiCommandManager.isShiftDown)
        ...
        viewModel->setParameterValue(9, viewModel->getParameterValue(9) +
                                            viewModel->getParameterInterval(9));
}
...
void ModifierView::encoder3Increased() {
    ...
    if (!midiCommandManager.isShiftDown)
        ...
        viewModel->setParameterValue(10,
                                     viewModel->getParameterValue(10) +
                                         viewModel->getParameterInterval(10));
}
...
void ModifierView::encoder4Increased() {
    ...
    if (!midiCommandManager.isShiftDown)
        ...
        viewModel->setParameterValue(11,
                                     viewModel->getParameterValue(11) +
                                         viewModel->getParameterInterval(11));
}
...
void ModifierView::parametersChanged() {
    ...
    for (int i = 0; i < viewModel->getNumberOfParameters(); i++) {
        ...
        knobs[i]->getSlider().setValue(viewModel->getParameterValue(i),
                                       juce::dontSendNotification);
    }
}
