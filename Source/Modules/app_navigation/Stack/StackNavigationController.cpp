...
StackNavigationController::~StackNavigationController() { clearStack(); }
...
void StackNavigationController::push(juce::Component *contentComponent) {
    ...
    listeners.call(
        [this](Listener &l) { l.stackComponentContentChanged(this); });
}
...
void StackNavigationController::clearStack() { pop(contentComponents.size()); }

int StackNavigationController::size() { return contentComponents.size(); }
