namespace app_view_models
{
    ...
    FourOscPluginViewModel::FourOscPluginViewModel(tracktion_engine::FourOscPlugin* p)
    ...
    int FourOscPluginViewModel::getNumberOfParameters()
    {
    ...
    double FourOscPluginViewModel::getParameterValue(int index)
    {
        switch(index)
        {
            ...
            case 12:
                return fourOscPlugin->oscParams[0]->pulseWidth->getCurrentNormalisedValue();
            case 13:
                return fourOscPlugin->oscParams[1]->pulseWidth->getCurrentNormalisedValue();
            case 14:
                return fourOscPlugin->oscParams[2]->pulseWidth->getCurrentNormalisedValue();
            case 15:
                return fourOscPlugin->oscParams[3]->pulseWidth->getCurrentNormalisedValue();
            default:
                return fourOscPlugin->ampAttack->getCurrentNormalisedValue();
