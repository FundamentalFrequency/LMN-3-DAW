namespace app_view_models
{
    ...
    void FilterViewModel::incrementAttack()
    {
        ...
        plugin->filterAttack->setNormalisedParameter(getAttack() + .01, juce::dontSendNotification);
    ...
    void FilterViewModel::incrementDecay()
    {
        ...
        plugin->filterDecay->setNormalisedParameter(getDecay() + .01, juce::dontSendNotification);
    ...
    void FilterViewModel::incrementSustain()
    {
        ...
        plugin->filterSustain->setNormalisedParameter(getSustain() + .01, juce::dontSendNotification);
    ...
    void FilterViewModel::incrementRelease()
    {
        ...
        plugin->filterRelease->setNormalisedParameter(getRelease() + .01, juce::dontSendNotification);
    ...
    void FilterViewModel::incrementFrequency()
    {
        ...
        double newNormalisedValue = filterNormRange.convertTo0to1(plugin->filterFreqValue.get()) + .02;
        if (newNormalisedValue < 1.0)
            plugin->filterFreqValue.setValue(filterNormRange.snapToLegalValue(filterNormRange.convertFrom0to1(newNormalisedValue)),
                                             nullptr);
        else
            plugin->filterFreqValue.setValue(filterNormRange.getRange().getEnd(), nullptr);
    ...
    void FilterViewModel::decrementFrequency()
    {
        ...
        if (newNormalisedValue > 0.0)
            ...
            plugin->filterFreqValue.setValue(filterNormRange.getRange().getStart(), nullptr);
    ...
    void FilterViewModel::incrementResonance()
    {
        ...
        plugin->filterResonance->setNormalisedParameter(getResonance() + .01, juce::dontSendNotification);
    ...
    void FilterViewModel::incrementEnvelopeAmount()
    {
        ...
        plugin->filterAmount->setNormalisedParameter(getEnvelopeAmount() + .01, juce::dontSendNotification);
    ...
    void FilterViewModel::valueTreePropertyChanged(juce::ValueTree &treeWhosePropertyHasChanged, const juce::Identifier &property)
    {
    ...
    void FilterViewModel::removeListener(Listener *l)
    {
