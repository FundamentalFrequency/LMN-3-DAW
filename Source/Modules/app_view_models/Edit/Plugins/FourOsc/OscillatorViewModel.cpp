...
namespace app_view_models
{
    ...
    OscillatorViewModel::OscillatorViewModel(tracktion_engine::FourOscPlugin* p, int oscIndex)
        : plugin(p),
    ...
    float OscillatorViewModel::getTune() const
    {
        ...
        return plugin->oscParams[oscillatorIndex]->tune->getCurrentNormalisedValue();
    ...
    float OscillatorViewModel::getFineTune() const
    {
        ...
        return plugin->oscParams[oscillatorIndex]->fineTune->getCurrentNormalisedValue();
    ...
    float OscillatorViewModel::getLevel() const
    {
        ...
        return plugin->oscParams[oscillatorIndex]->level->getCurrentNormalisedValue();
    ...
    float OscillatorViewModel::getPulseWidth() const
    {
        ...
        return plugin->oscParams[oscillatorIndex]->pulseWidth->getCurrentNormalisedValue();
    ...
    float OscillatorViewModel::getDetune() const
    {
        ...
        return plugin->oscParams[oscillatorIndex]->detune->getCurrentNormalisedValue();
    ...
    float OscillatorViewModel::getSpread() const
    {
        ...
        return plugin->oscParams[oscillatorIndex]->spread->getCurrentNormalisedValue();
    ...
    void OscillatorViewModel::incrementWaveShape()
    {
        ...
        if (getWaveShape() < 6)
            plugin->oscParams[oscillatorIndex]->waveShapeValue.setValue(getWaveShape() + 1, nullptr);
    ...
    void OscillatorViewModel::incrementVoices()
    {
        ...
        if (getVoices() < 8)
            plugin->oscParams[oscillatorIndex]->voicesValue.setValue(getVoices() + 1, nullptr);
    ...
    void OscillatorViewModel::incrementTune()
    {
        ...
        plugin->oscParams[oscillatorIndex]->tune->setNormalisedParameter(getTune() + .01, juce::dontSendNotification);
    ...
    void OscillatorViewModel::incrementFineTune()
    {
        ...
        plugin->oscParams[oscillatorIndex]->fineTune->setNormalisedParameter(getFineTune() + .01, juce::dontSendNotification);
    ...
    void OscillatorViewModel::incrementLevel()
    {
        ...
        plugin->oscParams[oscillatorIndex]->level->setNormalisedParameter(getLevel() + .01, juce::dontSendNotification);
    ...
    void OscillatorViewModel::incrementPulseWidth()
    {
        ...
        plugin->oscParams[oscillatorIndex]->pulseWidth->setNormalisedParameter(getPulseWidth() + .01, juce::dontSendNotification);
    ...
    void OscillatorViewModel::incrementDetune()
    {
        ...
        plugin->oscParams[oscillatorIndex]->detune->setNormalisedParameter(getDetune() + .01, juce::dontSendNotification);
    ...
    void OscillatorViewModel::incrementSpread()
    {
        ...
        plugin->oscParams[oscillatorIndex]->spread->setNormalisedParameter(getSpread() + .01, juce::dontSendNotification);
    ...
    void OscillatorViewModel::incrementPan()
    {
        ...
        plugin->oscParams[oscillatorIndex]->pan->setNormalisedParameter(getPan() + .01, juce::dontSendNotification);
    ...
    void OscillatorViewModel::valueTreePropertyChanged(juce::ValueTree &treeWhosePropertyHasChanged, const juce::Identifier &property)
    {
    ...
    void OscillatorViewModel::removeListener(Listener *l)
    {
