...
namespace app_view_models
{
    ...
    ADSRViewModel::ADSRViewModel(tracktion_engine::FourOscPlugin* p)
            : plugin(p)
    {
    ...
    void ADSRViewModel::incrementAttack()
    {
        ...
        plugin->ampAttack->setNormalisedParameter(getAttack() + .01, juce::dontSendNotification);
    ...
    void ADSRViewModel::incrementDecay()
    {
        ...
        plugin->ampDecay->setNormalisedParameter(getDecay() + .01, juce::dontSendNotification);
    ...
    void ADSRViewModel::incrementSustain()
    {
        ...
        plugin->ampSustain->setNormalisedParameter(getSustain() + .01, juce::dontSendNotification);
    ...
    void ADSRViewModel::incrementRelease()
    {
        ...
        plugin->ampRelease->setNormalisedParameter(getRelease() + .01, juce::dontSendNotification);
    ...
    void ADSRViewModel::valueTreePropertyChanged(juce::ValueTree &treeWhosePropertyHasChanged, const juce::Identifier &property)
    {
    ...
    void ADSRViewModel::removeListener(Listener *l)
    {
