namespace app_view_models
{
    ...
    void ModifierViewModel::valueTreePropertyChanged(juce::ValueTree &treeWhosePropertyHasChanged, const juce::Identifier &property)
    {
    ...
    void ModifierViewModel::removeListener(Listener *l)
    {
