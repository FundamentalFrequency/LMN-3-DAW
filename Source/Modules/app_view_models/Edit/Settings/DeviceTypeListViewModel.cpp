namespace app_view_models {
    DeviceTypeListViewModel::DeviceTypeListViewModel(tracktion_engine::Edit& e, juce::AudioDeviceManager& dm)
    : deviceManager(dm),
      state(e.state.getOrCreateChildWithName(IDs::SETTINGS_VIEW_STATE, nullptr)
                    .getOrCreateChildWithName(IDs::DEVICE_TYPE_LIST_VIEW_STATE,nullptr)),
      itemListState(state, deviceTypes.size()) {
        ...
        int currentDeviceIndex = deviceTypes.indexOf(deviceManager.getCurrentAudioDeviceType());
