...
namespace app_view_models {
    namespace IDs {
        const juce::Identifier SAMPLE_RATE_LIST_VIEW_STATE("SAMPLE_RATE_LIST_VIEW_STATE");
    }

    class SampleRateListViewModel: private ItemListState::Listener {
    public:
        SampleRateListViewModel(tracktion_engine::Edit& e, juce::AudioDeviceManager& dm);
