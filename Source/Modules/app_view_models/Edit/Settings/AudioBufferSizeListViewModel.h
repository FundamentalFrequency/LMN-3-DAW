...
namespace app_view_models {
    namespace IDs {
        const juce::Identifier AUDIO_BUFFER_SIZE_LIST_VIEW_STATE("AUDIO_BUFFER_SIZE_LIST_VIEW_STATE");
    }

    class AudioBufferSizeListViewModel: private ItemListState::Listener {
    public:
        AudioBufferSizeListViewModel(tracktion_engine::Edit& e, juce::AudioDeviceManager& dm);
