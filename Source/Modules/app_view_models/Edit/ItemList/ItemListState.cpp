...
namespace app_view_models
{
    ...
    int ItemListState::getSelectedItemIndex()
    {
    ...
    void ItemListState::removeListener(Listener *l)
    {
    ...
    void ItemListState::valueTreePropertyChanged(juce::ValueTree &treeWhosePropertyHasChanged, const juce::Identifier &property)
    {
