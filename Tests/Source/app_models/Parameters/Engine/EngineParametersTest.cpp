...
{
    class EngineParametersTests : public juce::UnitTest {

    public:

        EngineParametersTests() : juce::UnitTest("EngineParameters class", UnitTestCategories::app_models) {}

        void runTest() override {

            juce::String name = "Engine Parameters";
            double p1 = 0.1;
            double p2 = 0.2;
            double p3 = 0.3;
            double p4 = 0.4;

            juce::ValueTree parametersTree = app_models::StateBuilder::createEngineParameters(name, p1, p2, p3, p4);
    ...
    static EngineParametersTests engineParametersTests;
}
