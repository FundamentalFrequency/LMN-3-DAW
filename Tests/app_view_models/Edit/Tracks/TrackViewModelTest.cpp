...
namespace AppViewModelsTests
{
    ...
    TEST_F(TrackViewModelTest, clipAdded)
    {
        ...
        EXPECT_CALL(listener, clipsChanged(_))
                .Times(2);
    ...
    TEST_F(TrackViewModelTest, clipPositionChanged)
    {
        ...
        MockTrackViewModelListener listener;
        // called once when added listener added, once again when clip end time changed
        EXPECT_CALL(listener, clipPositionsChanged(_))
                .Times(2);
    ...
    TEST_F(TrackViewModelTest, transportChanged)
    {
        ...
        EXPECT_CALL(listener, transportChanged())
                .Times(2);
    ...
    TEST_F(TrackViewModelTest, deleteClipAtPlayheadWithPlayHeadAtStartOfCLip)
    {
    ...
    TEST_F(TrackViewModelTest, deleteClipAtPlayheadWithPlayHeadAtEndOfCLip)
    {
    ...
    TEST_F(TrackViewModelTest, deleteClipAtPlayheadWithPlayHeadAtMiddleOfCLip)
    {
